...
UserStatus.create(user_id: 2, missing_count: 0, status: "active", status: "active", status: "active")
UserStatus.create(user_id: 3, missing_count: 0, status: "active", status: "active")
